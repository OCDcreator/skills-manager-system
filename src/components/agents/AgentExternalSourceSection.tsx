...
interface AgentExternalSourceSectionProps {
...
export function AgentExternalSourceSection({
  agent,
  imports,
  record,
  repoPath,
  ...
  onRepairImport,
  onUpdateImport,
}: AgentExternalSourceSectionProps) {
                  ...
                  >
                    ...
                    <div className="flex justify-end">
                      <button
                        ...
                        onClick={() =>
                          void onImportVariant(record.id, agent.key, variant.variantPath)
                        }
                        type="button"
                      >
                        {!repoPath
