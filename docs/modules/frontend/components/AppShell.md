...
The shell reads `activeView`, `errorMessage`, and `setActiveView` from context. It renders the translated app title/subtitle, three view buttons, and an error strip when a context-level error exists.
