...
| `variantsWithSameContent` | Finds sibling variants with the same backend content fingerprint. |
| `equivalentContentGroupCount` | Counts duplicate-fingerprint groups for source-level summary badges. |
