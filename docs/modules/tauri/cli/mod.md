...
Downstream: src-tauri/src/cli/args.rs, src-tauri/src/cli/command_groups.rs, src-tauri/src/cli/commands/*, src-tauri/src/app_runtime/*
```
...
Must stay aligned with the `cli` Cargo feature and with the command labels exposed from `src-tauri/src/cli/command_groups.rs`.
