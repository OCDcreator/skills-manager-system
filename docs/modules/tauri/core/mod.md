...
Downstream: src-tauri/src/core/agents/mod.rs, src-tauri/src/core/git/mod.rs, src-tauri/src/core/scenes/mod.rs, src-tauri/src/core/settings.rs, src-tauri/src/core/skills/mod.rs
```
