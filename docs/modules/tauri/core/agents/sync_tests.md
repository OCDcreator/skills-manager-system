...
Builds disposable repositories and target directories to verify per-agent direct selection, scene/direct dedupe, exclusions, global hard-disable filtering, scoped apply, disabled-agent cleanup, and override-path precedence.
