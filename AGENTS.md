...
This project is indexed by GitNexus as **skills-manager-system** (5931 symbols, 10478 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
